...
{
    public partial class SP12 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sp = @"ALTER PROCEDURE [dbo].[sps_ClientsDemand]
	            ...
	            IF @ClientId IS NULL 
					...
					SELECT Top(20) dbo.Clients.Id As Id, dbo.Clients.Id AS ClientId, dbo.Demands.DemandStatusId AS DemandStatusId, CONVERT(bit, 'false') AS IsDeleted
					FROM dbo.Clients
